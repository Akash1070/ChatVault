...
## [0.1.11] - 2026-07-14
### Added
- Group conversations by project folder in the sidebar with collapsible/foldable sections.
- Scan for VS Code Copilot chat session logs in the workspace `chatSessions` folder.
- Real-time auto-capture polling frequency increased to 10 seconds.
- Instantly trigger a background poll check whenever the sidebar is loaded/refreshed.
### Fixed
- Fixed conversation dates and message timestamps showing incorrect dates/times.
- Fixed sidebar scroll container constraints to allow scrolling long lists of conversations.

## [0.1.10] - 2026-07-14
### Fixed
- Fixed parser to support JSON-lines formatted Antigravity brain logs so this conversation and past ones are correctly saved.

## [0.1.9] - 2026-07-14
### Fixed
- Fixed stale DB check and release build configuration.
